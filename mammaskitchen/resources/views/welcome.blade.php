                ...
                <div class="col-xs-12 col-sm-6 dis-table-cell">
                    <div class="section-content">
                        ...
                        <p class="section-content-para">
                            Located in the heart of Bandung, Restaurant Mantap offers a wide range of finest cuisines, in a casual and stylish atmosphere. The interior design is adapted with cozy ambience. Specialties ranging from European, Asian to Indonesian cuisines, brought to you by professional chef. For beverages there is various mixed of Coffee or Tea, Mocktails and juices, a wide collection of wines & cocktails.
                        </p>
                        <p class="section-content-para">
                            Restaurant Mantap is spacious enough to seat 650 people comfortably in indoor & outdoor areas. The parking space is supported with basement parking hold up to 80 cars and another 20 in front of the main building. Free Wi-Fi Internet Access is available here.
                        </p>
                    </div> <!-- /.section-content -->
                </div>
            </div> <!-- /.row -->
    ...
    <div class="container-fluid color-bg">
        <div class="row dis-table">
            ...
            <div class="col-xs-6 col-sm-6 dis-table-cell">
                <div class="section-content">
                    <p>Jalan Dipatiukur no.80-84, Bandung, Indonesia</p>
                    <p>+62 822 1234 5678</p>
                    <p>restaurant_mantap@mail.com </p>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <ul class="center-block">
                        ...
                        <li><a href="https://twitter.com" class="twit" target="_blank"></a></li>
                        <li><a href="https://hangouts.google.com" class="g-plus" target="_blank"></a></li>
                        <li><a href="https://linkedin.com" class="link" target="_blank"></a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="copyright text-center">
                    <p>
                        &copy; Copyright, {{ date('Y') }} <a href="#">Restaurant Mantap</a> <br><strong> Developed by </strong>
                        <a href="https://www.youtube.com/user/stendy17/videos" target="_blank">Stendy Iliandre</a>
                    </p>
                </div>
            </div>
        </div>
